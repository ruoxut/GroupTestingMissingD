#-------------------------------------------------------------------------------
#This file performs the simulation for \hat{p}_{ungr,N}.
...
#Number of groups J
J_sample = c(1250,1500,2500,3000,5000,6000,10000,12000,24000)
...
for (s in 1:length(J_sample))
{
  ...
  file_name = paste0("211011_iii_2_ungr_J", J, ".RData")
...
file_names = list.files(pattern="220213_ii_2_ungr_J")
